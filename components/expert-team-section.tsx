    ...
    <section id="instructors" className="py-20 bg-gradient-to-b from-gray-50 to-white relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-2xl p-6 md:p-12 shadow-2xl">
            <div className="text-center mb-12">
              <h3 className="text-2xl md:text-3xl font-bold text-black mb-4">
                Đội ngũ <span className="text-[#3264c3]">chuyên gia</span>
              </h3>
            </div>
            <div className="relative">
              ...
              <div className="flex items-center justify-center mt-4 md:hidden">
                <div className="flex items-center gap-2 bg-blue-50 px-4 py-2 rounded-full text-sm text-gray-600">
        ...
        <div className="bg-white rounded-2xl p-6 md:p-12 shadow-2xl relative">
          <div className="text-center mb-12">
            <h3 className="text-2xl md:text-3xl font-bold text-black mb-4">
              Đội ngũ <span className="text-[#3264c3]">giáo viên</span>
            </h3>
          </div>
          ...
          >
            {teachers.map((teacher) => (
              <div
                key={teacher.id}
                className="bg-gradient-to-br from-blue-50 to-purple-100 rounded-xl p-6 hover:scale-105 transition-transform duration-300 flex-shrink-0 w-80 snap-center"
              >
                <div className="aspect-[3/4] overflow-hidden rounded-lg mb-4 mx-auto max-w-[300px]">
                  <img
                ...
                <div>
                  <p className="text-[#3264c3] text-sm font-medium mb-1">{teacher.title}</p>
          ...
          <div className="flex items-center justify-center mt-6">
            <div className="flex items-center gap-2 bg-gradient-to-r from-blue-50 to-purple-50 px-6 py-3 rounded-full text-sm text-gray-600 shadow-sm">
              <Swipe className="w-4 h-4 text-blue-500" />
