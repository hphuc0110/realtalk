...
const experts = [
  ...
  },
  {
    ...
    description:
      "Chuyên gia giao tiếp quốc tế với chuyên môn sâu về văn hóa doanh nghiệp và kỹ năng thuyết trình.",
...
let teachers = [
  ...
  },
  {
    ...
    description:
      "Chuyên gia về giao tiếp và phát âm, giúp học viên tự tin trong mọi tình huống giao tiếp tiếng Anh.",
  ...
  },
  {
    ...
    description:
      "Giáo viên trẻ năng động với khả năng truyền cảm hứng học tập cho mọi lứa tuổi, đặc biệt là trẻ em.",
...
teachers = teachers.sort((a, b) => {
  ...
  const aIndex = priority.includes(a.id) ? priority.indexOf(a.id) : Infinity
  const bIndex = priority.includes(b.id) ? priority.indexOf(b.id) : Infinity
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-[#000072] mb-4">
            Đội ngũ Giảng viên & Chuyên gia
          </h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Đội ngũ giảng viên & chuyên gia HLE với nhiều năm kinh nghiệm giảng
            dạy, kết hợp phương pháp học tập thực dụng và cá nhân hóa 1-1, giúp
            học viên tháo gỡ những khó khăn của riêng mình và tiến bộ rõ rệt
            trong quá trình học.
          </p>
        </div>
          ...
          <div className="bg-white rounded-2xl p-8 md:p-12 shadow-2xl">
            <div className="text-center mb-12">
              <h3 className="text-2xl md:text-3xl font-bold text-black mb-4">
                Đội ngũ <span className="text-[#000072]">chuyên gia</span>
              </h3>
            </div>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {experts.map((expert) => (
                <div
                  key={expert.id}
                  className="bg-gradient-to-br from-blue-100 to-blue-200 rounded-xl p-6 hover:scale-105 transition-transform duration-300"
                >
                  ...
                  <div className="text-center">
                    <p className="text-[#cf0001] text-sm font-medium mb-1">
                      {expert.title}
                    </p>
        ...
        <div className="bg-white rounded-2xl p-8 md:p-12 shadow-2xl relative">
          <div className="text-center mb-12">
            <h3 className="text-2xl md:text-3xl font-bold text-black mb-4">
              Đội ngũ <span className="text-[#000072]">giáo viên</span>
            </h3>
          </div>
          ...
          <button
            onClick={() => scroll("left")}
            className="hidden md:flex absolute left-4 top-1/2 -translate-y-1/2 z-10 bg-white shadow-lg p-2 rounded-full hover:bg-gray-100"
          >
            <ChevronLeft className="w-6 h-6 text-gray-700" />
          </button>
          <button
            onClick={() => scroll("right")}
            className="hidden md:flex absolute right-4 top-1/2 -translate-y-1/2 z-10 bg-white shadow-lg p-2 rounded-full hover:bg-gray-100"
          >
          ...
          <div
            ref={scrollRef}
            className="flex flex-nowrap gap-6 overflow-x-auto scroll-smooth pb-4"
          >
            {teachers.map((teacher) => (
              <div
                key={teacher.id}
                className="bg-gradient-to-br from-blue-50 to-purple-100 rounded-xl p-6 hover:scale-105 transition-transform duration-300 flex-shrink-0 w-80"
              >
                <div className="aspect-[3/4] overflow-hidden rounded-lg mb-4 mx-auto max-w-[300px]">
                  <img
                ...
                <div>
                  <p className="text-[#000072] text-sm font-medium mb-1">
                    {teacher.title}
                  </p>
                  <h4 className="font-bold text-xl text-black mb-2">
                    {teacher.name}
